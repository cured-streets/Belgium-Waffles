...
Timing source: CapCut auto-lyrics JSON pasted by user.  
Purpose: approximate scene and shot planning for the AI music video.  
Runtime: approximately 2:12.37.

This is not a frame-locked edit. It is a production map for deciding which images/clips to generate.

## Shot Type Key

- **VIDEO**: strong candidate for image-to-video generation
- **STILL**: generated still with editorial motion/parallax
...
1. **V002** — Cowboy turns from stove
2. **V003** — Batter pour / first chorus hit
3. **V004** — Singer performs into whisk
4. **V005** — Syrup and jam pushed aside
5. **V006** — Couple stirs together during bridge
6. **V008** — Flour-cloud dance finale
7. **V009** — Product box placement
8. **V010** — Final thumbs-up/product hold

## Editorial Coverage Notes

- Use stills for establishing shots, reaction shots, and food beauty inserts.
- Save video-generation effort for actions that benefit from motion: turning, pouring, pushing props aside, stirring together, dancing, product placement, thumbs-up.
- Keep all readable packaging text blank during generation; add final label manually in post.
- Maintain literal waffle/cooking visuals at all times.
